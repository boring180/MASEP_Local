...
\section{Methodology}
    ...
    \subsection{Objective Statement Execution}
        ...
        \begin{itemize}
            ...
            The distortion parameter included in the intrinsic parameter can undistort the image for further application (Figure~\ref{undistrot}). As shown, barrel distortion is corrected using the radial distortion coefficients, compensating for lens imperfections. The performance of the undistortion algorithm can shape the detection accuracy of our system under complex light environments (e.g., with underwater light refraction).
...
Our main contributions are twofold. First, we proposed a ChArUco-based extrinsic calibration algorithm that addresses the fundamental limitation of traditional chessboard calibration in underwater environments. By leveraging the partial detection capability of ChArUco boards and PnP solvers, our method produces reliable inter-camera transformation matrices even when the full calibration pattern cannot be captured simultaneously by adjacent cameras. This achieved an extrinsic calibration error of $2.2\times 10^{-2}$~m. Second, we developed a nonlinear extrinsic calibration model that separately calibrates the camera intrinsic matrix $K$ and distortion model $D$. By modeling distortion as a vector field and training it via gradient descent with PyTorch, this approach overcomes the cross-medium light refraction that invalidates the standard pinhole camera assumption and traditional polynomial distortion models.
...
\addcontentsline{toc}{section}{Appendices}
    ...
    \addcontentsline{toc}{subsection}{Appendix A - Project Schedule}
        \begin{table}[H]
        \centering
        \caption{Project Gantt Chart\label{tab:schedule_gantt}}
        \begin{adjustbox}{max width=\textheight, angle=90}
        \begin{tabular}{|p{2.8cm}|p{2.8cm}|p{1.3cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|p{0.55cm}|}
        \hline
        Objective & Task & Member & \rotatebox{90}{WK1 28/7} & \rotatebox{90}{WK2 4/8} & \rotatebox{90}{WK3 11/8} & \rotatebox{90}{WK4 18/8} & \rotatebox{90}{WK5 25/8} & \rotatebox{90}{WK6 1/9} & \rotatebox{90}{WK7 8/9} & \rotatebox{90}{WK8 15/9} & \rotatebox{90}{WK9 22/9} & \rotatebox{90}{WK10 29/9} & \rotatebox{90}{WK11 6/10} & \rotatebox{90}{WK12 13/10} & \rotatebox{90}{WK13 20/10} & \rotatebox{90}{WK14 27/10} & \rotatebox{90}{WK15 3/11} & \rotatebox{90}{WK16 10/11} & \rotatebox{90}{WK17 17/11} & \rotatebox{90}{WK18 1/12} & \rotatebox{90}{WK19 8/12} & \rotatebox{90}{WK20 5/1} & \rotatebox{90}{WK21 12/1} & \rotatebox{90}{WK22 19/1} & \rotatebox{90}{WK23 2/2} & \rotatebox{90}{WK24 9/2} & \rotatebox{90}{WK25 16/2} & \rotatebox{90}{WK26 23/2} & \rotatebox{90}{WK27 2/3} \\
        \hline
        ...
        \hline
         &Simulation Framework Setup  &XU&\cellcolor{yellow!20}&\cellcolor{yellow!20}&  &  &  &  &  &  &  &  &  &  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&  &  & & & & & & & & & & \\
        \hline
        ...
        \hline
         Camera Array Calibration&  &  &  &\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}& &\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}\\
        \hline
        ...
        \hline
         &Intrinsic Calibration&Both&  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&&&&  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&  &  &  &  & & &\cellcolor{yellow!20}&\cellcolor{yellow!20}& & & & & & \\
        \hline
         &Extrinsic Calibration&Both&  &  &  &  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&  &  &  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&  &  &  & & &\cellcolor{yellow!20}&\cellcolor{yellow!20}& & & & & & \\
        \hline
         &Underwater Adjustment&Both&  &  &  &  &  &  &  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&  &  &  &  &\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}& & & & & & & & \\
        \hline
         ...
         \hline
         ArUco Tracking&  &  &  &  &\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&  &  &  &\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20} & & & & & & & & & & \\
         \hline
         ...
         \hline
         RSSI Localization&  &  &  &  & & & & & & & & & &\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}&\cellcolor{blue!20}& & \\
         \hline
         &RSSI Calibration&CHAN&  &  &  &  &  &  &  &  &  &  &  & & &\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}&\cellcolor{yellow!20}& & \\
        \hline
        \end{tabular}
        \end{adjustbox}
        \end{table}
